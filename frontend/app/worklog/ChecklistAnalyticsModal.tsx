...
const TITLE_ID = "worklog-checklist-analytics-title";
...
interface ChecklistAnalyticsModalProps {
  onClose: () => void;
}

// Checklist analytics (REQ-05 §10.14–10.17) — the three connected views
// (Overall Achievement Trend / Achievement by Item / Individual Item
// Tracking) share one selected date range. Resolution (daily/weekly/
// monthly) is decided server-side purely from the range length — this
// modal only ever passes from/to and renders whatever buckets come back.
export function ChecklistAnalyticsModal({ onClose }: ChecklistAnalyticsModalProps) {
