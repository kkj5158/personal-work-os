...
const pages=[{label:'Projects',path:'projects',icon:FolderKanban},{label:'Timeline',path:'timeline',icon:ChartGantt},{label:'To-do',path:'todo',icon:ListTodo},{label:'Today',path:'today',icon:NotebookPen}];
