...
export type WorkpadBlock = {id:string; parentId:string|null; order:number; type:'TEXT'|'BULLET'|'CHECKLIST'|'H1'|'H2'|'H3'|'CALLOUT'|'IMAGE'|'IMAGE_GROUP'|'DIVIDER'; content:string; checked:boolean; workTaskId:string|null; sourceBlockId:string|null; sourceDate:string|null; metadata:{images?:WorkflowImage[]; [key:string]:unknown}};
...
export const workflowApi = {
  ...
  saveDay:(date:string,day:Pick<WorkpadDay,'revision'|'blocks'>)=>apiClient.put<WorkpadDay>(`${base}/days/${date}`,day),
