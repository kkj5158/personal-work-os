import type { Challenge, DailyRecord, DietData, WeightGoal } from "./types";
...
export function goalFor(data:DietData,kind:WeightGoal["kind"]) { return data.goals.filter(g=>g.kind===kind).sort((a,b)=>b.date.localeCompare(a.date))[0]; }
