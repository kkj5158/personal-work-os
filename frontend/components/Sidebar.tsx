...
export function Sidebar() {
  ...
  if (pathname.startsWith("/notes") || pathname.startsWith("/calendar") || pathname.startsWith("/life") || pathname.startsWith("/diet") || pathname.startsWith("/workflow") || pathname.startsWith("/authoring") || pathname.startsWith("/money") || pathname === "/login") return null;
  return (
    <SharedSidebar
      system="WORK OS"
