...
![Current Notion dashboard](../assets/notion-ref/notion-dashboard.png)
...
![Adjust Work Time prototype](../assets/notion-ref/notion-adjust-work-time.png)
...
![Work Log Table prototype](../assets/notion-ref/notion-work-log-table.png)
...
![Attendance analytics prototype](../assets/notion-ref/notion-attendance-analytics.png)

![Weekly work trends prototype](../assets/notion-ref/notion-weekly-trends.png)

![Monthly work trends prototype](../assets/notion-ref/notion-monthly-trends.png)
...
![Work Status Dashboard prototype](../assets/notion-ref/notion-work-status-dashboard.png)

![Early Leave prototype](../assets/notion-ref/notion-early-leave.png)

### 2.5 Settings

The Notion prototype uses global lateness and leave rules.

![Lateness settings prototype](../assets/notion-ref/notion-settings-lateness.png)

![Leave settings prototype](../assets/notion-ref/notion-settings-leave.png)
...
![Current Notion Calendar workflow](../assets/notion-ref/notion-calendar-week.png)
