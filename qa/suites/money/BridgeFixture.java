  ...
  try(Connection c=DriverManager.getConnection(System.getenv("DEV_DB_URL"),p)) {
   ...
   try(Statement s=c.createStatement()) {
    ...
    if(action.equals("create")) {
     ...
     for(String file:List.of("V50__money_core_ledger.sql","V54__money_processing_schedule.sql","V55__money_v1_product.sql","V56__money_bridge_credentials.sql"))
     ...
     for(String table:List.of("money_corrections","money_balance_checkpoints","money_category_rules","money_transaction_sources","money_parse_attempts","money_raw_notifications","money_transactions","money_categories","money_accounts","money_bridge_enrollments","money_bridge_devices"))
